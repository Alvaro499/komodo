...
<body>
    <div class="container">
      <header class="header_top_nav">
            ...
            <div class="logo">
                <img src="../assets/logo/logo.svg" alt="Logo de la pagina" class="loco">
            </div>
        ...
        <div class="slider_cont">
            <div class="slider">
                <div class="slider_img">
                    <img src="../assets/img/img1.jpg" alt="Girasol">
                ...
                <div class="slider_img">
                    <img src="../assets/img/img2.jpg" alt="Ojo">
					<div class="slider_info">
						Ojo
					</div>
                </div>
                ...
                <div class="slider_img">
                    ...
                    <img src="../assets/img/img3.jpg" alt="Arbol">
					<div class="slider_info">
						Arbol
					</div>
                ...
                <div class="slider_img">
                    <img src="../assets/img/img4.png" alt="Chica">
					<div class="slider_info">
						Chica
					</div>
                </div>
                <div class="slider_img">
                    <img src="../assets/img/img5.jpg" alt="Auto">
					<div class="slider_info">
						Auto
					</div>
                </div>
                <div class="slider_img">
                    <img src="../assets/img/img6.jpg" alt="Saitama">
					<div class="slider_info">
						Saitama
					</div>
                </div>
        ...
        <section class="info_cards">
            ...
            <div class="card_container">
                <div class="card_father">
                    <div class="cards">
                        <div class="card_img">
                            <img src="../assets/flaticon/thread.svg" alt="Ilustración de hilo encerado" class="icon_cards">
                        </div>
                ...
                <div class="card_father">
                    <div class="cards">
                        <div class="card_img">
                            <img src="../assets/flaticon/all-inclusive.svg" alt="" class="icon_cards">
                        </div>
                ...
                <div class="card_father">
                    <div class="cards">
                        <div class="card_img">
                            <img src="../assets/flaticon/bracelet.svg" alt="" class="icon_cards">
                        </div>
                ...
                <div class="card_father">
                    <div class="cards">
                        <div class="card_img">
                            <img src="../assets/flaticon/variety.svg" alt="" class="icon_cards">
                        </div>
                        <h3>Variedad</h3>
